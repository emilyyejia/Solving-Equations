...
const PatternLevel2: React.FC<LevelComponentProps> = ({ onExit }) => (
  <div className="flex items-center justify-center h-full text-white text-center p-8">
    <div className="max-w-md bg-gray-800 p-8 rounded-2xl border border-gray-700 shadow-xl">
      <h2 className="text-3xl font-bold text-sky-400 mb-4 italic">Next Level Unlocked!</h2>
      <p className="text-gray-400 mb-8">This level is currently being updated with new challenges. Check back soon!</p>
